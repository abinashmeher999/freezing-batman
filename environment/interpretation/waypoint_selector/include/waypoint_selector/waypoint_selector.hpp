...
static const int altitude_preset = 59;
...
public:
    ...
    bool readWaypoints(std::ifstream& waypoints, std::vector<std::pair<sensor_msgs::NavSatFix, bool> >& gps_waypoints,int& no_waypoints, std::string filename);
